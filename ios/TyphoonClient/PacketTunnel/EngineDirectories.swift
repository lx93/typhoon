...
struct EngineDirectories {
    ...
    static func make() throws -> EngineDirectories {
        ...
        let base = try fileManager.url(
            ...
            appropriateFor: nil,
            create: true
        ).appendingPathComponent("TyphoonPacketTunnel", isDirectory: true)
        let working = base.appendingPathComponent("Working", isDirectory: true)
        let temporary = fileManager.temporaryDirectory.appendingPathComponent("TyphoonPacketTunnel", isDirectory: true)
